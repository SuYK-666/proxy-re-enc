...
$required = @(
  ...
  'docs/crypto/algorithm-spec.md',
  'docs/crypto/security-boundary.md',
  'docs/crypto/envelope-scheme.md',
  'docs/crypto/context-binding.md',
  'docs/crypto/threshold-re-encryption.md',
  'docs/crypto/versioning.md',
  'docs/api/authorization-matrix.md',
  'docs/api/error-codes.md',
  'docs/api/idempotency.md',
  'docs/revocation-and-rotation.md',
  'docs/audit-proof.md',
  'docs/data-model.md',
  'docs/database-migration.md',
  'docs/multi-tenant-isolation.md',
  'docs/secure-coding.md',
  'docs/experiments/experiment-plan.md',
  'docs/experiments/result-report.md',
  'docs/experiments/dataset-design.md',
  'docs/testing/security-regression.md',
  'docs/deployment.md',
  'docs/cli-verification.md',
  'docs/security/attack-test-matrix.md',
