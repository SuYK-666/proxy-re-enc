...
| 编号 | 实验 | 参数 | 严格通过条件 | 输出 |
| --- | --- | --- | --- | --- |
| E01 | secure envelope 正确性 | 20 rounds | 恢复与非授权拒绝均 100% | `e01-secure-envelope-correctness.csv` |
...
| E03 | chunked AEAD | 1/10/100 MB，chunk=1 MB | 全部解密验证通过且 100 MB 不 OOM | `e03-chunked-aead-results.csv` |
