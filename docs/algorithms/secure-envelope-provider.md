...
1. 使用 ephemeral private key 与 recipient public key 派生共享秘密。
1. 使用上下文 AAD 派生 KEK，并由 AES-GCM 包装 DEK。
1. recipient 使用自己的 private key 与 capsule 中 ephemeral public key 解封装。
